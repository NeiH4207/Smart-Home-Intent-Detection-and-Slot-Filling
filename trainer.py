            ...
            for step, batch in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0:
                    ...
                    if self.args.logging_steps > 0 and global_step % self.args.logging_steps == 0:
                        ...
                        results = self.evaluate("dev")
                        print("Loss/validation", results["loss"], _)
                        print("Intent Accuracy/validation", results["intent_acc"], _)
                        print("Slot F1/validation", results["slot_f1"], _)
                        print("Mean Intent Slot", results["mean_intent_slot"], _)
                        print("Sentence Accuracy/validation", results["semantic_frame_acc"], _)
